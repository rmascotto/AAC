...
public class SamlMetadataRelyingPartyRegistrationRepository implements RelyingPartyRegistrationRepository {

    // provider configs by id
    private final ProviderConfigRepository<SamlIdentityProviderConfig> registrationRepository;

    public SamlMetadataRelyingPartyRegistrationRepository(
