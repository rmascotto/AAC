...
package it.smartcommunitylab.aac.spid.controller;
...
import it.smartcommunitylab.aac.spid.provider.SpidLoginProvider;
...
@Controller
@ConditionalOnBean(SpidIdentityAuthority.class)
public class SpidLoginController {

    public static final String LOGIN_FORM_URL = SpidIdentityAuthority.AUTHORITY_URL + "form/{providerId}";
    ...
    public String login(
        ...
        // resolve provider
        SpidIdentityProvider idp = spidAuthority.getProvider(providerId);
        ...
        SpidLoginProvider a = idp.getLoginProvider(null, null);
